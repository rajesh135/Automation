...
class LaunchFacebook(unittest.TestCase):
    ...
    def test_search_automationstepbystep(self):
        ...
        self.driver.find_element_by_id("loginbutton").click()
        self.driver.save_screenshot('/home/rajesh/Documents/Stp-Assignment-2/reports/failed.png')
        time.sleep(2)
        ...
        self.driver.find_element_by_id("loginbutton").click()
        self.driver.save_screenshot('/home/rajesh/Documents/Stp-Assignment-2/reports/failedpwdempty.png')
        time.sleep(2)
        ...
        self.driver.find_element_by_name('pass').send_keys('')  # Enter empty Password
        self.driver.find_element_by_id("loginbutton").click()
        self.driver.save_screenshot('/home/rajesh/Documents/Stp-Assignment-2/reports/failedunameempty.png')
        time.sleep(2)
        ...
        self.driver.find_element_by_id("loginbutton1").click()#wrong element id
        self.driver.save_screenshot('/home/rajesh/Documents/Stp-Assignment-2/reports/failedwrongelementid.png')
        time.sleep(2)
